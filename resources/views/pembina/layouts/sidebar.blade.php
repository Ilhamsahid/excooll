<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            ...
            <div class="nav-item">
                <a href="#" class="nav-link" onclick="showSection('attendance')" data-section="attendance">
                    <span class="nav-icon">📊</span>
            ...
            <div class="nav-item">
                <a href="#" class="nav-link" onclick="showSection('activities')" data-section="activities">
                    <span class="nav-icon">🎪</span>
        ...
        <div class="nav-section">
            ...
            <div class="nav-item">
                <a href="#" class="nav-link" onclick="showSection('announcements')" data-section="announcements">
                    <span class="nav-icon">📢</span>
            ...
            <div class="nav-item">
                <a href="#" class="nav-link" onclick="showSection('applications')" data-section="applications">
                    <span class="nav-icon">📝</span>
