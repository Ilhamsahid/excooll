<div id="deleteModal" class="modal">
    <div class="modal-content">
        ...
        <div style="text-align: center; padding: var(--space-6) 0;">
            ...
            <h4 style="font-size: var(--font-size-xl); font-weight: var(--font-weight-bold); margin-bottom: var(--space-4); color: var(--text-primary);"
                id="nameObject">
        ...
        <div style="display: flex; gap: var(--space-4); justify-content: center; margin-top: var(--space-6);">
            ...
            <form id="deleteForm">
                <button class="btn btn-danger hover-lift" type="submit">
