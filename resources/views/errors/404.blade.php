...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | EkstraKu</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="content">
            <div class="left-content">
                ...
                <p class="error-message">
                    Maaf, halaman yang Anda cari tidak dapat ditemukan. Halaman mungkin telah dipindahkan, dihapus, atau tidak tersedia. Mari kembali ke halaman utama dan jelajahi konten menarik lainnya.
                </p>
                <a href="{{ request()->user() ? route('dashboard.' . request()->user()->role, 'dashboard') : route('ekstrasmexa')  }}" class="back-button" >
